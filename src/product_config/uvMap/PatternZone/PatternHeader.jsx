            ...
            <div className="flex items-center gap-1">
                {zoneMode ? (
                    <>
                        ...
                        <button
                            onClick={(e) => { e.stopPropagation(); dispatch(updatePatternState({ meshName, updates: { zoneMode: 'rect', polyPoints: [], drawingRect: null } })); }}
                        ...
                        <button
                            onClick={(e) => { e.stopPropagation(); dispatch(updatePatternState({ meshName, updates: { zoneMode: 'poly', drawingRect: null, polyPoints: [] } })); }}
                        ...
                        {zones.length > 0 && (
                            <button
                                onClick={(e) => { e.stopPropagation(); dispatch(updatePatternState({ meshName, updates: { zones: [], selectedZoneId: null } })); }}
                        ...
                        <button
                            onClick={(e) => { e.stopPropagation(); dispatch(updatePatternState({ meshName, updates: { zoneMode: null, drawingRect: null, polyPoints: [], cursorPos: null } })); }}
                    ...
                    <button
                        onClick={(e) => { e.stopPropagation(); dispatch(updatePatternState({ meshName, updates: { zoneMode: 'rect', selectedId: null } })); }}
                ...
                <button onClick={(e) => { e.stopPropagation(); triggerExport(); }} className="p-1 hover:bg-indigo-50 text-indigo-400 rounded-full" title="Sync 3D">
                    <Sparkles size={11} />
                </button>
                {(stickers.length > 0 || textNodes.length > 0) && (
                    <button
                        onClick={(e) => {
                            e.stopPropagation();
                            dispatch(updatePatternState({ meshName, updates: { stickers: [], textNodes: [], selectedId: null } }));
