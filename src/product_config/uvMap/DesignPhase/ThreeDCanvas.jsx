...
import ARViewerModal from "../../../ar/ARViewerModal";
...
export const ThreeDCanvas = ({
    ...
    const modelProps = useMemo(() => ({
        ...
        setMeshList: () => { },
        selectedMesh,
    }), [glbUrl, meshTextures, baseTextures, pbrTextures, meshMaterials, materialProps, selectedMesh]);
                ...
                <div className="bg-white/70 backdrop-blur-2xl border border-white/50 shadow-[0_30px_60px_rgba(0,0,0,0.1)] rounded-[2.5rem] overflow-hidden pointer-events-auto flex flex-col h-[700px] relative transition-all hover:shadow-[0_40px_80px_rgba(0,0,0,0.15)]">
                    ...
                    <div className="absolute top-6 left-6 right-6 z-10 flex items-center justify-between pointer-events-auto">
                        ...
                        <button
                            ...
                            className="flex items-center gap-1.5 bg-indigo-600/90 hover:bg-indigo-600 text-white backdrop-blur-xl px-3.5 py-1.5 rounded-xl text-xs font-bold shadow-lg shadow-indigo-500/20 transition-all hover:scale-105 active:scale-95 border border-white/20"
                        >
